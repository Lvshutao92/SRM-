...
- (void)click:(UITapGestureRecognizer *)event{
...
- (void)configUI
{
    ...
    [_btnCancel setTitleColor:XFTreePopupView_TINT_COLOR forState:UIControlStateNormal];
    ...
    [_btnOK setTitleColor:XFTreePopupView_TINT_COLOR forState:UIControlStateNormal];
...
- (void)initDataSource
{
    ...
    NSArray *c = [currentNode objectForKey:@"children"];
    NSInteger col = 0;
    while (c != nil && c.count != 0)
    {
        ...
        c = [firstColNode objectForKey:@"children"];
    }
...
- (NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component
{
    ...
    NSString *nodeName = [node objectForKey:@"value"];
